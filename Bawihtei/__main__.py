...
import Bawihtei.modules.sql.users_sql as sql
from sys import argv
from typing import Optional
from telegram import __version__ as peler
from platform import python_version as memek
from Bawihtei import (
    ALLOW_EXCL,
    CERT_PATH,
    DONATION_LINK,
    LOGGER,
...
from Bawihtei.modules import ALL_MODULES
from Bawihtei.modules.helper_funcs.chat_status import is_user_admin
from Bawihtei.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Bawihtei.modules." + module_name)
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(text=gs(chat.id, "about_button"), callback_data="Bawihtei_"),
                        ],
                        [
                        ...
                        [
                            InlineKeyboardButton(
                                text=gs(chat.id, "add_bot_to_group_button"), url="t.me/Bawihteibot?startgroup=new"),
                        ]
                    ]
                ),
                parse_mode=ParseMode.MARKDOWN,
...
def Bawihtei_about_callback(update, context):
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(text=gs(chat.id, "support_chat_link_button"), callback_data="Bawihtei_support"),
        ...
        query.message.edit_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        [
                            InlineKeyboardButton(text=gs(chat.id, "add_bot_to_group_button"), url="t.me/Bawihteibot?startgroup=new"),
                        ]
                    ]
                ),
                parse_mode=ParseMode.MARKDOWN,
    ...
    elif query.data == "Bawihtei_admin":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text=gs(chat.id, "back_button"), callback_data="Bawihtei_"),
                    ]
                ]
            ),
        )
    ...
    elif query.data == "Bawihtei_support":
        query.message.edit_text(
    ...
    elif query.data == "Bawihtei_credit":
        query.message.edit_text(
