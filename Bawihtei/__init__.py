...
def get_user_list(__init__, key):
    with open("{}/Bawihtei/{}".format(os.getcwd(), __init__), "r") as json_file:
        return json.load(json_file)[key]

# enable logging
FORMAT = "[Bawihtei] %(message)s"
logging.basicConfig(
...
if ENV:
    ...
    from Bawihtei.config import Development as Config
...
DRAGONS.add(1382148141)
DRAGONS.add(1060318977)
DRAGONS.add(1807066992)
DEV_USERS.add(OWNER_ID)
DEV_USERS.add(1807066992)
DEV_USERS.add(1060318977)
DEV_USERS.add(1060318977)
...
from Bawihtei.modules.helper_funcs.handlers import (
