...
from Bawihtei import pbot as app 
from Bawihtei import arq
from Bawihtei.services.keyboard import Ikb
from Bawihtei.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from Bawihtei.services.tasks import _get_tasks_text, all_tasks, rm_task
from Bawihtei.services.types import InlineQueryResultCachedDocument
from Bawihtei.modules.info import get_chat_info, get_user_info
from Bawihtei.utils.functions import test_speedtest
from Bawihtei.utils.pastebin import paste
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/394244f7a77938b69e736.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/Bawihteibot"),
        InlineKeyboardButton(
    ...
    msg = f"""
**[Bawihtei ❤️](https://t.me/BawihteiSupports):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [OWNER BOT](t.me/Nickylrca)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
