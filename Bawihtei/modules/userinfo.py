...
from Bawihtei.__main__ import STATS, TOKEN, USER_INFO
from Bawihtei.modules.sql import SESSION
import Bawihtei.modules.sql.userinfo_sql as sql
from Bawihtei.modules.disable import DisableAbleCommandHandler
from Bawihtei.modules.sql.global_bans_sql import is_user_gbanned
from Bawihtei.modules.sql.afk_sql import is_afk, set_afk
from Bawihtei.modules.sql.users_sql import get_user_num_chats
from Bawihtei.modules.helper_funcs.chat_status import sudo_plus
from Bawihtei.modules.helper_funcs.extraction import extract_user
...
def stats(update: Update, context: CallbackContext):
    stats = "<b>╔═━「 Current Bawihtei Statistics 」</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
    result = re.sub(r"(\d+)", r"<code>\1</code>", stats)
    result += "\n<b>╘═━「 Powered By @BawihteiBot 」</b>"
    update.effective_message.reply_text(
        result,
        parse_mode=ParseMode.HTML, 
        disable_web_page_preview=True
