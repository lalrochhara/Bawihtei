...
import Bawihtei.modules.sql.notes_sql as sql
from Bawihtei import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from Bawihtei.__main__ import DATA_IMPORT
from Bawihtei.modules.helper_funcs.chat_status import user_admin
from Bawihtei.modules.helper_funcs.alternate import typing_action

# from Bawihtei.modules.rules import get_rules
import Bawihtei.modules.sql.rules_sql as rulessql

# from Bawihtei.modules.sql import warns_sql as warnssql
import Bawihtei.modules.sql.blacklist_sql as blacklistsql
from Bawihtei.modules.sql import disable_sql as disabledsql

# from Bawihtei.modules.sql import cust_filters_sql as filtersql
# import Bawihtei.modules.sql.welcome_sql as welcsql
import Bawihtei.modules.sql.locks_sql as locksql
from Bawihtei.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("Bawihtei{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Bawihtei{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Bawihtei-Backup` was specially made for notes.".format(
            chat.title,
            chat_id,
            tgl,
        ),
    ...
    os.remove("Bawihtei{}.backup".format(chat_id))  # Cleaning file
