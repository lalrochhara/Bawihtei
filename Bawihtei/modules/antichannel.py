...
from Bawihtei.modules.helper_funcs.decorators import Bawihteicmd, Bawihteimsg
from Bawihtei.modules.helper_funcs.channel_mode import user_admin, AdminPerms
from Bawihtei.modules.sql.antichannel_sql import antichannel_status, disable_antichannel, enable_antichannel
from Bawihtei.modules.language import gs

@Bawihteicmd(command="antichannelmode", group=100)
...
@Bawihteimsg(Filters.chat_type.groups, group=110)
