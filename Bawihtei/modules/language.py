import itertools
import Bawihtei.modules.sql.language_sql as sql
...
from Bawihtei.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from Bawihtei.language import get_string, get_languages, get_language
    ...
    keyb.append(
        [
            InlineKeyboardButton(
                ...
                url="https://poeditor.com/join/project?hash=uU3eI4lulk",
            )
        ]
    )
