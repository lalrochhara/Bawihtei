...
import telegram
from Bawihtei import TIGERS, WOLVES, dispatcher
from Bawihtei.modules.disable import DisableAbleCommandHandler
from Bawihtei.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from Bawihtei.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from Bawihtei.modules.helper_funcs.string_handling import split_quotes
from Bawihtei.modules.log_channel import loggable
from Bawihtei.modules.sql import warns_sql as sql
...
def warn(user: User,
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # Bawihtei's sticker
        keyboard = None
