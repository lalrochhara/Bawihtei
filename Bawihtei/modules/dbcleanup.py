...
import Bawihtei.modules.sql.global_bans_sql as gban_sql
import Bawihtei.modules.sql.users_sql as user_sql
from Bawihtei import DEV_USERS, OWNER_ID, dispatcher
