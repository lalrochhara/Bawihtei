...
from Bawihtei import dispatcher, telethn
from Bawihtei.__main__ import (
    CHAT_SETTINGS,
    DATA_EXPORT,
    DATA_IMPORT,
    HELPABLE,
...
from Bawihtei.modules.helper_funcs.chat_status import dev_plus, sudo_plus
...
def unload(update: Update, context: CallbackContext):
    ...
    try:
        imported_module = importlib.import_module("Bawihtei.modules." + text)
    except:
...
def listmodules(update: Update, context: CallbackContext):
    ...
    for helpable_module in HELPABLE:
        ...
        file_name = file_info.__name__.rsplit("Bawihtei.modules.", 1)[1]
